...
Source1  : https://github.com/SSSD/sssd/releases/download/2.9.0/sssd-2.9.0.tar.gz.asc
...
%prep
%setup -q -n sssd-2.9.0
cd %{_builddir}/sssd-2.9.0
%patch -P 1 -p1
pushd ..
cp -a sssd-2.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686070328
