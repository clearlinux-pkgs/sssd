...
%prep
%setup -q -n sssd-2.2.3
cd %{_builddir}/sssd-2.2.3
...
cp %{_builddir}/sssd-2.2.3/src/sss_client/COPYING %{buildroot}/usr/share/package-licenses/sssd/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/sssd-2.2.3/src/sss_client/COPYING.LESSER %{buildroot}/usr/share/package-licenses/sssd/978773e74b4cfcbe611ae1217754f259ad37ac96
%make_install
%find_lang sssd
