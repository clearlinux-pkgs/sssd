...
Version  : 2.11.0
Release  : 65
URL      : https://github.com/SSSD/sssd/releases/download/2.11.0/sssd-2.11.0.tar.gz
Source0  : https://github.com/SSSD/sssd/releases/download/2.11.0/sssd-2.11.0.tar.gz
Source1  : sssd.tmpfiles
Source2  : https://github.com/SSSD/sssd/releases/download/2.11.0/sssd-2.11.0.tar.gz.asc
...
%setup -q -n sssd-2.11.0
cd %{_builddir}/sssd-2.11.0
pushd ..
cp -a sssd-2.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749168692
...
/V3/usr/lib64/libsss_idmap.so.0.6.0
/V3/usr/lib64/libsss_nss_idmap.so.0.6.1
...
/V3/usr/lib64/sssd/libsss_idp.so
...
/usr/lib64/libsss_idmap.so.0.6.0
/usr/lib64/libsss_nss_idmap.so.0
/usr/lib64/libsss_nss_idmap.so.0.6.1
